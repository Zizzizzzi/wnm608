...
$empty_product = (object)[
    ...
    "amount"=>"3",
	"style"=>"abstract",
    "description"=>"abstract is the best art.",
	"thumbnail"=>"art_abstract_thumb.jpg",
	"images"=>"art_abstract_thumb.jpg,art_abstract_2.jpg,art_abstract_3.jpg"
];
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
   ...
   <div class="form-control">
       <label class="form-label" for="product-style"> Style</label>
       <input class="form-input" name="product-style" id="product-style" type="text" value="$o->style" placeholder="Enter the Product Style" >
   </div>
